# Generated by Django 3.1.2 on 2021-02-14 05:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='material_type', to='dushanbe.type')),
            ],
            options={
